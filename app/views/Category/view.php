...
<section class="inner-banner py-5">
    <div class="breadcrumb py-lg-5">
        <div class="breadcrumb">
            <div class="container pt-sm-5 pt-4 pb-sm-4">
                ...
                <li><span class="fa fa-chevron-right mx-2" aria-hidden="true"></span><?=$breadcrumbs;?></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <!-- products -->
<div style="text-align: center; padding: 6.5rem 0 1rem;">
            ...
            <section class="home">
                <div class="home__container container">
                    <div class="home__data">
                        ...
                        <h1 class="home__title">Эй, Приятель</h1>
                        <p class="home__description">
                        В этой категории <br> товаров пока нет...
                        </p>
                        <a href="<?=PATH;?>" class="home__button">
                            Вернуться на главную
                        </a>
                    </div>
                        
                    <div class="home__img">
                        <img src="/public/errors/assets/img/ghost-img.png" alt="">
                        <div class="home__shadow"></div>
                    </div>
                </div>

                <footer class="home__footer">
                    <span>+7(978)593-82-69</span>
                    <span>|</span>
                    <span>horologium@mail.ru</span>
                </footer>
            </section>
        </main>
